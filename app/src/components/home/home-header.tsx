  ...
  return (
    <View className="flex-row items-center justify-between">
      <View className="flex-row items-center gap-3">
        ...
        <View>
          <Text className="font-body-bold text-[13px] leading-[16px] text-ink-muted">{greeting}</Text>
          <Text variant="title">{name}</Text>
        </View>
      </View>
      <IconButton accessibilityLabel={notificationsLabel} onPress={onPressNotifications}>
